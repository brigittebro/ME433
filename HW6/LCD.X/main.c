 ...
 *
 * Created on June 9, 2018, 9:30 PM
 */
 ...
 * 
void LCD_asciiWrite(unsigned char); //write ascii character to LCD
void LCD_progressBar(unsigned short, unsigned short); // show a progress bar given start pos and length
 * 
*/
